      ...
      <section ref={containerRef} className="h-[285svh] md:h-[300vh] w-full">
        <div className="sticky top-0 h-[100svh] md:h-screen w-full overflow-hidden flex">
          <div className="absolute inset-0 w-full h-full flex flex-col md:flex-row z-10">
            <div className="order-2 md:order-1 w-full md:w-1/2 h-[56svh] md:h-full bg-turquoise-light flex flex-col justify-start md:justify-center px-6 md:px-24 pt-8 pb-10 md:py-0">
            ...
            <div className="absolute inset-0 flex items-center justify-center z-30 pointer-events-none">
              <DividerOrnament vertical className="hidden md:flex drop-shadow-xl scale-[1.5]" />
              <DividerOrnament className="flex md:hidden drop-shadow-xl scale-110" />
            </div>
          </div>
          ...
          <div className="absolute inset-0 w-full h-full flex flex-col md:flex-row pointer-events-none z-20">
            ...
            <motion.div style={{ x: execTextX }} className="w-full md:w-1/2 h-[56svh] md:h-full bg-orange-dark flex flex-col justify-start md:justify-center px-6 md:px-24 pt-8 pb-10 md:py-0 pointer-events-auto shadow-2xl">
          ...
          <div className="absolute inset-0 w-full h-full flex flex-col md:flex-row pointer-events-none z-30">
            <motion.div style={{ x: manageTextX }} className="order-2 md:order-1 w-full md:w-1/2 h-[56svh] md:h-full bg-turquoise-dark flex flex-col justify-start md:justify-center px-6 md:px-24 pt-8 pb-10 md:py-0 pointer-events-auto shadow-2xl">
