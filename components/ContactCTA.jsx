        ...
        <form className="max-w-3xl mx-auto space-y-7 md:space-y-8 text-left bg-orange-dark p-8 md:p-14 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-white/10 relative overflow-hidden backdrop-blur-sm">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-7 md:gap-8">
            <div>
              ...
              <input type="text" className="w-full bg-transparent border-b border-[#012c3d]/20 pb-2 text-[#012c3d] placeholder-[#012c3d]/40 focus:outline-none focus:border-accent transition-colors" />
            </div>
            <div>
              <label className="block text-xs tracking-widest text-[#012c3d]/70 uppercase mb-2">Last Name</label>
              <input type="text" className="w-full bg-transparent border-b border-[#012c3d]/20 pb-2 text-[#012c3d] placeholder-[#012c3d]/40 focus:outline-none focus:border-accent transition-colors" />
            </div>
          </div>
          <div>
            <label className="block text-xs tracking-widest text-[#012c3d]/70 uppercase mb-2">Email Address</label>
            <input type="email" className="w-full bg-transparent border-b border-[#012c3d]/20 pb-2 text-[#012c3d] placeholder-[#012c3d]/40 focus:outline-none focus:border-accent transition-colors" />
          </div>
          <div>
            <label className="block text-xs tracking-widest text-[#012c3d]/70 uppercase mb-2">Tell us about your project</label>
            <textarea rows="4" className="w-full bg-transparent border-b border-[#012c3d]/20 pb-2 text-[#012c3d] placeholder-[#012c3d]/40 focus:outline-none focus:border-accent transition-colors resize-none"></textarea>
          </div>
