export default function ContactCTA() {
  return (
    <section id="contact" className="bg-[#1a1a1a] py-20 md:py-32 px-5 md:px-12 border-t border-white/5 scroll-mt-24">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <form className="max-w-2xl mx-auto space-y-7 md:space-y-8 text-left">
          ...
          <div className="pt-8 text-center">
            <button type="button" className="w-full sm:w-auto bg-[#C8AC6B] text-black font-serif px-12 py-4 hover:bg-white transition-colors duration-300">
              Submit Inquiry
            </button>
          </div>
        </form>
